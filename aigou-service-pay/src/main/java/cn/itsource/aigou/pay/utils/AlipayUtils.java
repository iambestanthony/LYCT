...
public class AlipayUtils {
	...
	public static String generatePayData(PayBill payBill) {
		...
		//http://nxh.nat123.cc/alipayNotify 支付成功与否以异步通知为准
		...
		//http://127.0.0.1:80/payResult?sn=支付单号
		tradePageRequest.setReturnUrl(GlobalSetting.get(GlobalSettingNames.URL_PAY)
				+ GlobalSetting.get(GlobalSettingNames.URL_PAY_RETURN_URL) + "?sn=" + payBill.getUnionPaySn());//payResult
		try {
